...
0 INLINE \ Prevent inlining because of relative offset to RP
 ...
 6 LIBMIT-PRIMITIVE MIT_GET_STACK
 7 LIBMIT-PRIMITIVE MIT_SET_STACK
 8 LIBMIT-PRIMITIVE MIT_GET_STACK_WORDS
 9 LIBMIT-PRIMITIVE MIT_SET_STACK_WORDS
10 LIBMIT-PRIMITIVE MIT_CURRENT_STATE
11 LIBMIT-PRIMITIVE MIT_LOAD_STACK
12 LIBMIT-PRIMITIVE MIT_STORE_STACK
13 LIBMIT-PRIMITIVE MIT_POP_STACK
14 LIBMIT-PRIMITIVE MIT_PUSH_STACK
15 LIBMIT-PRIMITIVE MIT_NEW_STATE
16 LIBMIT-PRIMITIVE MIT_FREE_STATE
17 LIBMIT-PRIMITIVE MIT_RUN
18 LIBMIT-PRIMITIVE MIT_SINGLE_STEP
19 LIBMIT-PRIMITIVE TOTAL-ARGS
20 LIBMIT-PRIMITIVE MIT_ARG
21 LIBMIT-PRIMITIVE MIT_REGISTER_ARGS
22 LIBMIT-PRIMITIVE MIT_EXTRA_INSTRUCTION
23 LIBMIT-PRIMITIVE MIT_CORE_DUMP
24 LIBMIT-PRIMITIVE MIT_SPECIALIZER_RUN
25 LIBMIT-PRIMITIVE MIT_PROFILE_INIT
26 LIBMIT-PRIMITIVE MIT_PROFILE_RUN
27 LIBMIT-PRIMITIVE MIT_PROFILE_DUMP
28 LIBMIT-PRIMITIVE MIT_STEP_TO


\ Stack management primitives

0 0 PRIMITIVE SP@
\ MIT_CURRENT_STATE MIT_GET_STACK_DEPTH
MLIT NOPALIGN
10 ,  $0101 ,
MLIT NOPALIGN
4 ,  $0101 ,
...
\ MIT_CURRENT_STATE MIT_SET_STACK_DEPTH
10 ,  $0101 ,
MLIT NOPALIGN
5 ,  $0101 ,
END-PRIMITIVE
