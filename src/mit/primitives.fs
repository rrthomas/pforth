...
2 2 PRIMITIVE U/MOD
MUDIVMOD MPUSH MSWAP NOPALIGN
0 ,
END-PRIMITIVE

2 2 PRIMITIVE S/REM
MDIVMOD MPUSH MSWAP NOPALIGN
0 ,
END-PRIMITIVE

2 1 PRIMITIVE =
MXOR MPUSH MULT MNEGATE
1 ,
END-PRIMITIVE
...
\ LINK, and UNLINK,
1 0 PRIMITIVE >R
MPUSHREL MPUSH MDUP MLOAD
' RP >BODY OFFSET,
0 ,
MPUSH MADD MPUSH MDUP
-4 , \ FIXME: target -CELL, not -4
0 ,
MPUSH MSWAP MSTORE MSTORE
1 ,
END-PRIMITIVE
...
' RP >BODY OFFSET,
0 ,
MPUSH MDUP MPUSH MADD
0 ,
4 , \ FIXME: target CELL, not 4
MPUSH MSWAP MPUSH MSWAP
0 ,  1 ,
MSTORE MLOAD
END-PRIMITIVE
0 INLINE \ Prevent inlining: it's too long to go at the start of each word!
...
MPUSH MLSHIFT NOPALIGN
2 , \ FIXME constant!
END-PRIMITIVE

\ FIXME: -9 THROW if out of range
1 0 PRIMITIVE SP!
MPUSH MRSHIFT NOPALIGN
2 , \ FIXME constant!
