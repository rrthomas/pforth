...
CODE ARGLEN   BARGLEN BRET END-CODE 2 INLINE
CODE ARGCOPY   BARGCOPY BRET END-CODE 2 INLINE
CODE TOTAL-ARGS   BARGC BRET END-CODE 2 INLINE

CODE STDIN   BSTDIN BRET END-CODE 2 INLINE
CODE STDOUT   BSTDOUT BRET END-CODE 2 INLINE
CODE STDERR   BSTDERR BRET END-CODE 2 INLINE
CODE OPEN-FILE   BOPEN-FILE BRET END-CODE 2 INLINE
CODE CLOSE-FILE   BCLOSE-FILE BRET END-CODE 2 INLINE
CODE READ-FILE   BREAD-FILE BRET END-CODE 2 INLINE
CODE WRITE-FILE   BWRITE-FILE BRET END-CODE 2 INLINE
CODE FILE-POSITION   BFILE-POSITION BRET END-CODE 2 INLINE
CODE REPOSITION-FILE   BREPOSITION-FILE BRET END-CODE 2 INLINE
