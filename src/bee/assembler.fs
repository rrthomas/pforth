...
: LIBC-TRAP   CREATE  ,  DOES> @ BPUSH LIBC ;
: LIBC-TRAPS   SWAP 1+ SWAP DO  I LIBC-TRAP  LOOP ;
 2  0 LIBC-TRAPS BARGC BARGLEN BARGCOPY
 5  3 LIBC-TRAPS BSTDIN BSTDOUT BSTDERR
 7  6 LIBC-TRAPS BOPEN-FILE BCLOSE-FILE
 9  8 LIBC-TRAPS BREAD-FILE BWRITE-FILE
11 10 LIBC-TRAPS BFILE-POSITION BREPOSITION-FILE
14 12 LIBC-TRAPS BFLUSH-FILE BRENAME-FILE BDELETE-FILE
16 15 LIBC-TRAPS BFILE-SIZE BRESIZE-FILE
17    LIBC-TRAP  BFILE-STATUS
