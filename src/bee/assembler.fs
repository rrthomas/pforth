...
37 32 INSTS BPUSHR   BPOPR    BDUPR    BCATCH   BTHROW   BBREAK

71 64 INSTS BWORD_BYTES BGET_M0 BGET_MSIZE BGET_RSIZE BGET_RP BSET_RP BGET_SSIZE BGET_SP
73 72 INSTS BSET_SP BGET_HANDLER_RP
