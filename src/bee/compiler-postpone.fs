...
: BRANCH   ( at from to -- )   HERE >R
   ROT DP !  ,  51 , ( FIXME: BJUMP )  DROP  R> DP ! ;

: AHEAD   HERE  0 ,  51 , ( FIXME: BJUMP ) ; IMMEDIATE COMPILING
: IF   HERE  0 ,  55 , ( FIXME: BJUMPZ ) ; IMMEDIATE COMPILING

: DOES-LINK,   POSTPONE R> POSTPONE DROP ;
: LINK, ;
: UNLINK,   63 , ( FIXME: BRET ) ; COMPILING
