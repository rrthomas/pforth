...
: BRANCH   ( at from to -- )   HERE >R
   ROT DP !  ,  $CB , ( FIXME: BJUMP )  DROP  R> DP ! ;

: AHEAD   HERE  0 ,  $CB , ( FIXME: BJUMP ) ; IMMEDIATE COMPILING
: IF   HERE  0 ,  $DB , ( FIXME: BJUMPZ ) ; IMMEDIATE COMPILING

: DOES-LINK,   POSTPONE R> POSTPONE DROP ;
: LINK, ;
: UNLINK,   $FB , ( FIXME: BRET ) ; COMPILING
