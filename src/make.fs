...
: IS   ' >BODY  DUP ADD-RELOCATION  !  ; \ FIXME: really DEFER!
   :NONAME   ALIGN '  POSTPONE RELATIVE-LITERAL  POSTPONE DEFER! ;IMMEDIATE
: TO   ' >BODY ! ;
...
' RELATIVE-LITERAL TO CURRENT-RELATIVE-LITERAL
' LITERAL, TO CURRENT-LITERAL,
...
'FORTH 6 ROLL !   \ store 'FORTH in RELOCATION-TABLE
