...
$A7 $A0 0OPS  BEXTRA BPUSH_PSIZE BPUSH_SP BSTORE_SP BPUSH_RP BSTORE_RP BPUSH_PC BPUSH_S0
$AF $A8 0OPS  BPUSH_SSIZE BPUSH_R0 BPUSH_RSIZE BPUSH_HANDLER BSTORE_HANDLER BPUSH_MEMORY BPUSH_BADPC BPUSH_INVALID
