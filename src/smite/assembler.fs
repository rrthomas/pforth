...
$9F $98 0OPS  BSTOREB BBRANCH BBRANCHZ BCALL  BRET    BTHROW  BHALT   BLINK
$A7 $A0 0OPS  BEXTRA BPUSH_WORD_SIZE B_PUSH_ADDRESS_SIZE BPUSH_NATIVE_POINTER_SIZE BPUSH_SP BSTORE_SP BPUSH_RP BSTORE_RP
$AF $A8 0OPS  BPUSH_PC BPUSH_S0 BPUSH_SSIZE BPUSH_R0 BPUSH_RSIZE BPUSH_HANDLER BSTORE_HANDLER BPUSH_MEMORY
$B1 $B0 0OPS  BPUSH_BADPC BPUSH_INVALID
