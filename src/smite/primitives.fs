...
CODE SP@   BPUSH_SP CELL LITERAL, BMUL BRET END-CODE  3 INLINE
CODE SP!   CELL LITERAL, BUDIVMOD ] 1 [ BPOP BSTORE_SP BRET END-CODE  5 INLINE
CODE RP@   BPUSH_RP CELL LITERAL, BMUL BRET END-CODE  3 INLINE
CODE RP!   CELL LITERAL, BUDIVMOD ] 1 [ BPOP BSTORE_RP BRET END-CODE  5 INLINE
