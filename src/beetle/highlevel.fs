...
\ FIXME: defined in primitives.fs
\ : UNLOOP   POSTPONE 2R>  POSTPONE 2DROP ; IMMEDIATE COMPILING
...
\ FIXME: This is machine-dependent!
...
: VOCABULARY   WORDLIST <M0  CREATE  ,  DOES>  #ORDER @ 0= IF  1 #ORDER +!
   THEN  @ CONTEXT ! ;
VOCABULARY FORTH
' FORTH >BODY @ ( FIXME: <M0 ) CONSTANT FORTH-WORDLIST
...
: (FORGET)
   ...
   BEGIN  @ ?DUP WHILE
      DUP CELL - ( FIXME: CELL- ) @  DUP  #THREADS CELLS +  SWAP DO
         I DUP
