...
CODE CELL/   B2/ B2/ BEXIT END-CODE  2 INLINE
 ...
 9 PRIMITIVES U/MOD /MOD S/REM / MOD MAX MIN ABS NEGATE
12 PRIMITIVES AND OR XOR INVERT LSHIFT RSHIFT THROW @ ! C@ C! +!
CODE BYE   B1 BHALT END-CODE  2 INLINE
 6 PRIMITIVES J EXIT SP@ SP! RP@ RP!
 4 PRIMITIVES UNLOOP HALT LIB LINK
